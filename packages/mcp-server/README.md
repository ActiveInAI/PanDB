...
Rust-powered Model Context Protocol server for [DBX](https://github.com/ActiveInAI/PanDB). It lets MCP-compatible AI agents inspect schemas and run safe database operations using connections configured in DBX.
...
DBX MCP Server 是 [DBX](https://github.com/ActiveInAI/PanDB) 的 Rust MCP 服务，让 Claude Code、Cursor、Windsurf 等兼容 MCP 的 AI 工具使用 DBX 中已有的连接查询数据库。
