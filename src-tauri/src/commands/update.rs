...
mod tests {
    ...
    fn rewrites_github_asset_url_to_cnb() {
        let download_url = UpdateDownloadSource::Cnb
            .rewrite_download_url("https://github.com/t8y2/dbx/releases/download/v0.5.39/PanDB_0.5.39_aarch64.dmg")
            .unwrap()
            .unwrap();
        assert_eq!(download_url, "https://cnb.cool/dbxio.com/dbx/-/releases/download/v0.5.39/PanDB_0.5.39_aarch64.dmg");
    }

    #[test]
    fn accepts_existing_cnb_asset_url() {
        let download_url = UpdateDownloadSource::Cnb
            .rewrite_download_url("https://cnb.cool/dbxio.com/dbx/-/releases/download/v0.5.39/PanDB_0.5.39_aarch64.dmg")
            .unwrap();
    ...
    fn builds_installer_asset_candidates_for_cnb_source() {
        let candidates = UpdateDownloadSource::Cnb.installer_asset_candidates(
            "https://github.com/t8y2/dbx/releases/download/v0.5.64/PanDB_0.5.64_aarch64.dmg",
            Some("0.5.64"),
        );
        assert_eq!(candidates.len(), 3);
        assert_eq!(
            candidates[0],
            "https://cnb.cool/dbxio.com/dbx/-/releases/download/v0.5.64/PanDB_0.5.64_aarch64.dmg"
        );
        assert_eq!(candidates[1], format!("{R2_LATEST_RELEASE_DOWNLOAD_PREFIX}PanDB_0.5.64_aarch64.dmg"));
        assert_eq!(candidates[2], "https://github.com/t8y2/dbx/releases/download/v0.5.64/PanDB_0.5.64_aarch64.dmg");
    }
    ...
    fn builds_installer_asset_candidates_for_official_source() {
        ...
        assert_eq!(candidates[1], "https://github.com/t8y2/dbx/releases/download/v0.5.64/PanDB_0.5.64_aarch64.dmg");
