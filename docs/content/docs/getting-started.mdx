...
<Tabs groupId="platform" items={['macOS', 'Windows', 'Linux', 'Docker']}>
  <Tab value="macOS">
    ...
    You can also download a `.dmg` installer from [GitHub Releases](https://github.com/ActiveInAI/PanDB/releases).
  ...
  <Tab value="Windows">
    ...
    You can also download a `.msi` installer from [GitHub Releases](https://github.com/ActiveInAI/PanDB/releases).
  ...
  <Tab value="Linux">
    ...
    You can also download a package from [GitHub Releases](https://github.com/ActiveInAI/PanDB/releases):
