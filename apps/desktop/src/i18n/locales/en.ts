...
export default {
  ...
  updates: {
    ...
    portableAutomaticUpdate: "PanDB will download the signed portable ZIP, replace only PanDB.exe after exit, and restart automatically. portable.dbx and data will be kept.",
  ...
  sqlLibrary: {
    title: "SQL Library",
    storageHelp: "SQL Library content is stored in PanDB app data, not as standalone .sql files on disk.\nTo use files in the file system, export the SQL Library.",
  ...
  connection: {
    ...
    rememberPasswordSaveFailed: "Connected, but PanDB could not remember the password: {message}",
  ...
  grid: {
    ...
    conditionalBulkEditConfirmMessage: "This executes immediately against every row matching the condition at execution time. Unloaded rows are included, and PanDB cannot generate a reliable rollback for them.",
  ...
  ai: {
    ...
    closeWithRunsDescription: "Quitting PanDB will interrupt {count} running or queued AI task(s). You can close this dialog and let them finish instead.",
    ...
    productionWriteBlocked: "AI cannot execute data or schema changes on a production database. Review this SQL and run it manually in PanDB.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "A PanDB-managed MCP environment variable was overridden. Remove PanDB_MCP_* variables from the provider configuration.",
      ...
      piAgentEnvReserved: "A PanDB-managed Pi or MCP environment variable was overridden. Remove PanDB_PI_* and PanDB_MCP_* variables from the provider configuration.",
      ...
      openCodeEnvReserved: "An OpenCode or PanDB-managed environment variable was overridden. Remove OPENCODE control variables and PanDB_MCP_* variables from the provider configuration.",
      ...
      openCodeMcpStartupFailed: "OpenCode could not start the scoped PanDB MCP server. Check Settings > MCP and the diagnostics below.",
      ...
      grokCliEnvReserved: "A PanDB-managed MCP environment variable was overridden. Remove PanDB_MCP_* variables from the provider configuration.",
      grokCliNotAuthenticated: "Grok CLI is not authenticated. Run `grok login` in a terminal and try again.",
      grokCliMcpStartupFailed: "Grok loaded the MCP configuration but could not start PanDB MCP Server. Check Settings > MCP and the diagnostics below.",
      grokCliCommandLineTooLong: "Windows rejected the Grok CLI command because it was too long. Update PanDB and retry using the generated prompt file.",
      ...
      codeBuddyEnvReserved: "A PanDB-managed MCP environment variable was overridden. Remove PanDB_MCP_* variables from the provider configuration.",
      ...
      codeBuddyMcpConfigInvalid: "CodeBuddy Code could not read the temporary PanDB MCP configuration. Check the diagnostics below.",
      codeBuddyMcpStartupFailed: "CodeBuddy Code loaded the MCP configuration but could not start PanDB MCP Server. Check Settings > MCP and the diagnostics below.",
      ...
      qoderEnvReserved: "A PanDB-managed MCP environment variable was overridden. Remove PanDB_MCP_* variables from the provider configuration.",
      ...
      qoderMcpConfigInvalid: "Qoder CLI could not read the temporary PanDB MCP configuration. Check the Qoder CLI version and diagnostics below.",
      qoderMcpStartupFailed: "Qoder CLI loaded the MCP configuration but could not start PanDB MCP Server. Check Settings > MCP and the diagnostics below.",
      ...
      cursorEnvReserved: "A Cursor or PanDB-managed environment variable was overridden. Remove CURSOR_CONFIG_DIR, CURSOR_DATA_DIR, and PanDB_MCP_* variables from the provider configuration.",
      cursorNotAuthenticated: "Cursor CLI is not authenticated. Run `agent login` in a terminal and try again.",
      cursorMcpStartupFailed: "Cursor could not start the scoped PanDB MCP server. Check Settings > MCP and the diagnostics below.",
  ...
  settings: {
    ...
    syncWebDavWebDescription: "In Web mode, the PanDB server accesses WebDAV without browser CORS restrictions. Saved passwords remain in the current PanDB instance.",
    ...
    syncRememberWebDavPasswordDescription: "The password is encrypted and stored in the current PanDB instance only. It is not synced to WebDAV and does not replace the sync password.",
    ...
    syncSecretsPassphraseDescription: "This password is only used to encrypt and restore sensitive data. It is encrypted in the current PanDB instance; enter it again in other instances.",
    syncTest: "Test",
    syncUpload: "Upload",
    ...
    appCloseUnsavedTabsModeDescription: "Choose what happens when quitting PanDB while SQL tabs have unsaved edits.",
    appCloseUnsavedTabsModePrompt: "Ask whether to save",
    appCloseUnsavedTabsModeKeepDrafts: "Quit and keep drafts",
    appCloseUnsavedTabsModeHint: 'Drafts are kept as unsaved tabs and restored the next time you start PanDB. This requires "Restore tabs on launch" to not be set to "Do not keep tabs".',
    appCloseDraftPersistFailed: "PanDB could not save the open tab drafts, so quitting was cancelled. Check disk space and file permissions, then try again. Details: {message}",
    ...
    mcpUninstallConfirm: "Uninstall PanDB MCP Server? Configured MCP clients will no longer be able to start it.",
    ...
    mcpNpmBoundary: "PanDB checks MCP status; installation, upgrades, and uninstallation run through the detected npm or pnpm runtime.",
  ...
  driverStore: {
    ...
    offlineExportDescription: "Select the PanDB-managed Agent drivers to include. The package is compatible with the current platform only.",
    ...
    offlineExportNoDrivers: "No eligible PanDB-managed Agent drivers are installed.",
    ...
    offlineExportSecurityHint: "Only PanDB-managed artifacts and required managed JREs are included. Local paths, settings, and external drivers are excluded.",
    ...
    offlineExportUnavailable_unmanagedInstall: "This artifact is not tracked as a PanDB-managed installation.",
    ...
    offlineExportUnavailable_missingManagedJre: "The required PanDB-managed JRE is not installed.",
    offlineExportUnavailable_invalidManagedJre: "The required PanDB-managed JRE is invalid or unsafe.",
    refresh: "Refresh",
    ...
    localInstallHint: "For air-gapped machines: on another computer with internet access, download the official dbx-jdbc-plugin-*.zip from the PanDB GitHub Releases page, transfer it here, and select it — no network access is needed on this machine.",
  ...
  nacos: {
    ...
    protectedRole: "The built-in administrator role cannot be removed from PanDB.",
    close: "Close",
    ...
    namespaceIdPlaceholder: "Leave empty for PanDB to generate a UUID",
    namespaceName: "Namespace Name",
    ...
    nacosDetectAccessibleNamespacesHint: "PanDB verifies configuration and service read access before offering namespaces for {name}.",
    ...
    nacosV3ConsoleManagedNamespacesHint: "This uses the Nacos 3 Console API (normally port 8080). Enter a namespace name or ID; PanDB converts a name to its actual ID when it can read the directory.",
