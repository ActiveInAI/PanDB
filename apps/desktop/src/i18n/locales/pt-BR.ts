...
export default withEnglishFallback({
  ...
  updates: {
    ...
    portableAutomaticUpdate: "O PanDB baixará o ZIP portátil assinado, substituirá apenas o PanDB.exe após sair e reiniciará automaticamente. O portable.dbx e os dados serão mantidos.",
  ...
  sqlLibrary: {
    ...
    storageHelp: "O conteúdo da Biblioteca SQL é salvo nos dados do aplicativo PanDB, não como arquivos .sql independentes no disco.\nPara usá-lo no sistema de arquivos, exporte a Biblioteca SQL.",
  ...
  connection: {
    ...
    rememberPasswordSaveFailed: "Conectado, mas o PanDB não conseguiu lembrar a senha: {message}",
  ...
  grid: {
    ...
    conditionalBulkEditConfirmMessage: "Esta operação atualiza imediatamente todas as linhas correspondentes no momento da execução, incluindo linhas não carregadas. O PanDB não pode gerar uma reversão confiável.",
  ...
  ai: {
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "Uma variável MCP gerenciada pelo PanDB foi sobrescrita. Remova as variáveis PanDB_MCP_* da configuração do provedor.",
      ...
      piAgentEnvReserved: "Uma variável Pi ou MCP gerenciada pelo PanDB foi sobrescrita. Remova PanDB_PI_* e PanDB_MCP_* da configuração.",
      ...
      openCodeEnvReserved: "Uma variável gerenciada pelo OpenCode ou PanDB foi sobrescrita. Remova as variáveis de controle OPENCODE e PanDB_MCP_* da configuração.",
      ...
      openCodeMcpStartupFailed: "O OpenCode não conseguiu iniciar o servidor PanDB MCP com escopo restrito. Verifique Configurações > MCP e os detalhes abaixo.",
      ...
      cursorEnvReserved: "Uma variável gerenciada pelo Cursor ou PanDB foi sobrescrita. Remova CURSOR_CONFIG_DIR, CURSOR_DATA_DIR e PanDB_MCP_* da configuração.",
      cursorNotAuthenticated: "O Cursor CLI não está autenticado. Execute `agent login` no terminal e tente novamente.",
      cursorMcpStartupFailed: "O Cursor não conseguiu iniciar o servidor PanDB MCP com escopo restrito. Verifique Configurações > MCP e os detalhes abaixo.",
      ...
      grokCliEnvReserved: "Uma variável MCP gerenciada pelo PanDB foi sobrescrita. Remova as variáveis PanDB_MCP_* da configuração do provedor.",
      grokCliNotAuthenticated: "Grok CLI não está autenticado. Execute `grok login` em um terminal e tente novamente.",
      grokCliMcpStartupFailed: "O Grok carregou a configuração MCP, mas não conseguiu iniciar o PanDB MCP Server. Verifique Configurações > MCP e os detalhes abaixo.",
      grokCliCommandLineTooLong: "O Windows rejeitou o comando do Grok CLI porque era muito longo. Atualize o PanDB e tente novamente com o arquivo de prompt gerado.",
      ...
      codeBuddyEnvReserved: "Uma variável MCP gerenciada pelo PanDB foi sobrescrita. Remova as variáveis PanDB_MCP_* da configuração do provedor.",
      ...
      codeBuddyMcpConfigInvalid: "O CodeBuddy Code não conseguiu ler a configuração temporária do PanDB MCP. Verifique os detalhes abaixo.",
      codeBuddyMcpStartupFailed: "O CodeBuddy Code carregou a configuração MCP, mas não conseguiu iniciar o PanDB MCP Server. Verifique Configurações > MCP e os detalhes abaixo.",
      ...
      qoderEnvReserved: "Uma variável de ambiente MCP gerenciada pelo PanDB foi sobrescrita. Remova as variáveis PanDB_MCP_* da configuração do provedor.",
      ...
      qoderMcpConfigInvalid: "O Qoder CLI não conseguiu ler a configuração MCP temporária do PanDB. Verifique a versão do Qoder CLI e os detalhes abaixo.",
      qoderMcpStartupFailed: "O Qoder CLI carregou a configuração MCP, mas não conseguiu iniciar o PanDB MCP Server. Verifique Configurações > MCP e os detalhes abaixo.",
    ...
    closeWithRunsDescription: "Sair do PanDB interromperá {count} tarefa(s) de AI em execução ou na fila. Você também pode fechar esta caixa de diálogo e deixá-las terminar.",
    ...
    productionWriteBlocked: "A IA não pode executar alterações de dados ou esquema em um banco de dados de produção. Revise este SQL e execute-o manualmente no PanDB.",
  ...
  settings: {
    ...
    syncWebDavWebDescription: "No modo Web, o servidor PanDB acessa o WebDAV sem as restrições de CORS do navegador. As senhas salvas permanecem na instância PanDB atual.",
    ...
    syncRememberWebDavPasswordDescription: "A senha é criptografada e armazenada apenas na instância PanDB atual. Ela não é sincronizada para o WebDAV e não substitui a senha de sincronização.",
    ...
    syncSecretsPassphraseDescription: "Esta senha é usada apenas para criptografar e restaurar dados sensíveis. Ela é criptografada na instância PanDB atual; digite-a novamente em outras instâncias.",
    syncTest: "Testar",
    syncUpload: "Enviar",
    syncDownload: "Baixar",
    ...
    appCloseUnsavedTabsModeDescription: "Escolha o que acontece ao sair do PanDB com abas SQL contendo edições não salvas.",
    appCloseUnsavedTabsModePrompt: "Perguntar se deseja salvar",
    appCloseUnsavedTabsModeKeepDrafts: "Sair e manter rascunhos",
    appCloseUnsavedTabsModeHint: 'Os rascunhos são mantidos como abas não salvas e restaurados na próxima vez que você iniciar o PanDB. Requer que "Restaurar abas ao iniciar" não esteja definido como "Não manter abas".',
    appCloseDraftPersistFailed: "O PanDB não conseguiu salvar os rascunhos das abas abertas, então a saída foi cancelada. Verifique o espaço em disco e as permissões dos arquivos e tente novamente. Detalhes: {message}",
  ...
  driverStore: {
    ...
    offlineExportDescription: "Selecione os drivers Agent gerenciados pelo PanDB que serão incluídos. O pacote é compatível apenas com a plataforma atual.",
    ...
    offlineExportNoDrivers: "Nenhum driver Agent gerenciado pelo PanDB elegível está instalado.",
    ...
    offlineExportSecurityHint: "Somente artefatos gerenciados pelo PanDB e as JRE necessárias são incluídos. Caminhos locais, configurações e drivers externos são excluídos.",
    ...
    offlineExportUnavailable_unmanagedInstall: "O artefato não está registrado como uma instalação gerenciada pelo PanDB.",
    ...
    offlineExportUnavailable_missingManagedJre: "A JRE gerenciada pelo PanDB necessária não está instalada.",
    offlineExportUnavailable_invalidManagedJre: "A JRE gerenciada pelo PanDB necessária é inválida ou insegura.",
    refresh: "Atualizar",
    ...
    localInstallHint: "Para ambientes sem acesso à internet: em outro computador com internet, baixe o dbx-jdbc-plugin-*.zip oficial na página de Releases do PanDB no GitHub, transfira-o para esta máquina e selecione-o — nenhum acesso à rede é necessário aqui.",
  ...
  nacos: {
    ...
    namespaceIdPlaceholder: "Deixe vazio para o PanDB gerar um UUID",
    ...
    nacosDetectAccessibleNamespacesHint: "O PanDB verifica a leitura de configurações e serviços antes de oferecer namespaces para {name}.",
    ...
    nacosV3ConsoleManagedNamespacesHint: "Esta conexao usa a API Console do Nacos 3 (normalmente a porta 8080). Informe um nome ou ID de namespace; o PanDB converte o nome no ID real quando consegue ler o diretorio.",
