...
export default withEnglishFallback({
  ...
  updates: {
    ...
    portableAutomaticUpdate: "PanDB descargará el ZIP portable firmado, reemplazará solo PanDB.exe después de salir y se reiniciará automáticamente. portable.dbx y data se conservarán.",
  ...
  sqlLibrary: {
    ...
    storageHelp: "El contenido de la Biblioteca SQL se guarda en los datos de la aplicación PanDB, no como archivos .sql independientes en el disco.\nPara usarlo en el sistema de archivos, exporta la Biblioteca SQL.",
  ...
  connection: {
    ...
    rememberPasswordSaveFailed: "Conectado, pero PanDB no pudo recordar la contraseña: {message}",
  ...
  grid: {
    ...
    conditionalBulkEditConfirmMessage: "Esta operación actualiza inmediatamente todas las filas que coincidan al ejecutarse, incluidas las no cargadas. PanDB no puede generar una reversión fiable para ellas.",
  ...
  ai: {
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "Se sobrescribió una variable MCP administrada por PanDB. Elimina las variables PanDB_MCP_* de la configuración del proveedor.",
      ...
      piAgentEnvReserved: "Se sobrescribió una variable de Pi o MCP administrada por PanDB. Elimina PanDB_PI_* y PanDB_MCP_* de la configuración.",
      ...
      openCodeEnvReserved: "Se intentó sobrescribir una variable administrada por OpenCode o PanDB. Elimina las variables de control OPENCODE y PanDB_MCP_* de la configuración.",
      ...
      openCodeMcpStartupFailed: "OpenCode no pudo iniciar el servidor PanDB MCP con ámbito restringido. Revisa Ajustes > MCP y los detalles siguientes.",
      ...
      cursorEnvReserved: "Se intentó sobrescribir una variable administrada por Cursor o PanDB. Elimina CURSOR_CONFIG_DIR, CURSOR_DATA_DIR y PanDB_MCP_* de la configuración.",
      cursorNotAuthenticated: "Cursor CLI no está autenticado. Ejecuta `agent login` en una terminal y vuelve a intentarlo.",
      cursorMcpStartupFailed: "Cursor no pudo iniciar el servidor PanDB MCP con ámbito restringido. Revisa Ajustes > MCP y los detalles siguientes.",
      ...
      grokCliEnvReserved: "Se sobrescribió una variable MCP gestionada por PanDB. Elimina las variables PanDB_MCP_* de la configuración del proveedor.",
      grokCliNotAuthenticated: "Grok CLI no está autenticado. Ejecuta `grok login` en una terminal e inténtalo de nuevo.",
      grokCliMcpStartupFailed: "Grok cargó la configuración MCP pero no pudo iniciar PanDB MCP Server. Revisa Ajustes > MCP y los diagnósticos siguientes.",
      grokCliCommandLineTooLong: "Windows rechazó el comando de Grok CLI porque era demasiado largo. Actualiza PanDB y vuelve a intentarlo con el archivo de prompt generado.",
      ...
      codeBuddyEnvReserved: "Se sobrescribió una variable MCP gestionada por PanDB. Elimina las variables PanDB_MCP_* de la configuración del proveedor.",
      ...
      codeBuddyMcpConfigInvalid: "CodeBuddy Code no pudo leer la configuración temporal de PanDB MCP. Revisa los diagnósticos siguientes.",
      codeBuddyMcpStartupFailed: "CodeBuddy Code cargó la configuración MCP pero no pudo iniciar PanDB MCP Server. Revisa Ajustes > MCP y los diagnósticos siguientes.",
      ...
      qoderEnvReserved: "Se sobrescribió una variable de entorno MCP administrada por PanDB. Elimina las variables PanDB_MCP_* de la configuración del proveedor.",
      ...
      qoderMcpConfigInvalid: "Qoder CLI no pudo leer la configuración MCP temporal de PanDB. Comprueba la versión de Qoder CLI y los diagnósticos siguientes.",
      qoderMcpStartupFailed: "Qoder CLI cargó la configuración MCP, pero no pudo iniciar PanDB MCP Server. Comprueba Configuración > MCP y los diagnósticos siguientes.",
    ...
    closeWithRunsDescription: "Salir de PanDB interrumpirá {count} tarea(s) de AI en ejecución o en cola. También puedes cerrar este diálogo y dejar que terminen.",
    ...
    productionWriteBlocked: "La IA no puede ejecutar cambios de datos o esquema en una base de datos de producción. Revisa este SQL y ejecútalo manualmente en PanDB.",
  ...
  settings: {
    ...
    syncWebDavWebDescription: "En modo Web, el servidor PanDB accede a WebDAV sin las restricciones CORS del navegador. Las contraseñas guardadas permanecen en la instancia PanDB actual.",
    ...
    syncRememberWebDavPasswordDescription: "La contraseña se cifra y se guarda solo en la instancia PanDB actual. No se sincroniza a WebDAV ni reemplaza la contraseña de sync.",
    ...
    syncSecretsPassphraseDescription: "Esta contraseña solo se usa para cifrar y restaurar datos sensibles. Se cifra en la instancia PanDB actual; vuelve a ingresarla en otras instancias.",
    syncTest: "Probar",
    syncUpload: "Subir",
    ...
    appCloseUnsavedTabsModeDescription: "Elige qué ocurre al salir de PanDB con pestañas SQL que tienen ediciones sin guardar.",
    appCloseUnsavedTabsModePrompt: "Preguntar si guardar",
    appCloseUnsavedTabsModeKeepDrafts: "Salir y conservar borradores",
    appCloseUnsavedTabsModeHint: 'Los borradores se conservan como pestañas sin guardar y se restauran la próxima vez que inicies PanDB. Requiere que "Restaurar pestañas al iniciar" no esté en "No conservar pestañas".',
    appCloseDraftPersistFailed: "PanDB no pudo guardar los borradores de las pestañas abiertas, por lo que se canceló la salida. Comprueba el espacio en disco y los permisos de los archivos, y vuelve a intentarlo. Detalles: {message}",
  ...
  driverStore: {
    ...
    offlineExportDescription: "Selecciona los drivers Agent administrados por PanDB que se incluirán. El paquete solo es compatible con la plataforma actual.",
    ...
    offlineExportNoDrivers: "No hay drivers Agent administrados por PanDB que se puedan exportar.",
    ...
    offlineExportSecurityHint: "Solo se incluyen artefactos administrados por PanDB y los JRE necesarios. Se excluyen rutas locales, configuraciones y drivers externos.",
    ...
    offlineExportUnavailable_unmanagedInstall: "El artefacto no está registrado como una instalación administrada por PanDB.",
    ...
    offlineExportUnavailable_missingManagedJre: "El JRE administrado por PanDB requerido no está instalado.",
    offlineExportUnavailable_invalidManagedJre: "El JRE administrado por PanDB requerido no es válido o no es seguro.",
    refresh: "Actualizar",
    ...
    localInstallHint: "Para entornos sin acceso a internet: en otro equipo con conexión, descarga el dbx-jdbc-plugin-*.zip oficial desde la página de Releases de PanDB en GitHub, transfiérelo a esta máquina y selecciónalo; no se necesita acceso a la red en este equipo.",
  ...
  nacos: {
    ...
    namespaceIdPlaceholder: "Déjalo vacío para que PanDB genere un UUID",
    ...
    nacosDetectAccessibleNamespacesHint: "PanDB verifica el acceso de lectura a configuraciones y servicios antes de ofrecer namespaces para {name}.",
    ...
    nacosV3ConsoleManagedNamespacesHint: "Esta conexión usa la API Console de Nacos 3 (normalmente el puerto 8080). Introduce un nombre o ID de namespace; PanDB convierte el nombre al ID real cuando puede leer el directorio.",
