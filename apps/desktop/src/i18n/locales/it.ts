...
export default withEnglishFallback({
  ...
  updates: {
    ...
    portableAutomaticUpdate: "PanDB scaricherà lo ZIP portatile firmato, sostituirà solo PanDB.exe dopo l'uscita e si riavvierà automaticamente. portable.dbx e i dati verranno mantenuti.",
  ...
  sqlLibrary: {
    title: "Libreria SQL",
    storageHelp: "Il contenuto della Libreria SQL viene salvato nei dati dell'app PanDB, non come file .sql autonomi sul disco.\nPer usarlo nel file system, esporta la Libreria SQL.",
  ...
  connection: {
    ...
    rememberPasswordSaveFailed: "Connessione riuscita, ma PanDB non ha potuto memorizzare la password: {message}",
  ...
  grid: {
    ...
    conditionalBulkEditConfirmMessage: "L'operazione aggiorna immediatamente tutte le righe corrispondenti al momento dell'esecuzione, incluse quelle non caricate. PanDB non può generare un rollback affidabile.",
  ...
  ai: {
    ...
    closeWithRunsDescription: "Uscire da PanDB interromperà {count} attività di AI in esecuzione o in coda. Puoi anche chiudere questa finestra e lasciarle terminare.",
    ...
    productionWriteBlocked: "L'AI non può eseguire modifiche a dati o schema su un database di produzione. Rivedi questo SQL ed eseguilo manualmente in PanDB.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "È stata sovrascritta una variabile MCP gestita da PanDB. Rimuovi le variabili PanDB_MCP_* dalla configurazione del provider.",
      ...
      piAgentEnvReserved: "È stata sovrascritta una variabile Pi o MCP gestita da PanDB. Rimuovi PanDB_PI_* e PanDB_MCP_* dalla configurazione.",
      ...
      openCodeEnvReserved: "È stata sovrascritta una variabile gestita da OpenCode o PanDB. Rimuovi le variabili di controllo OPENCODE e PanDB_MCP_* dalla configurazione.",
      ...
      openCodeMcpStartupFailed: "OpenCode non ha potuto avviare il server PanDB MCP con ambito limitato. Controlla Impostazioni > MCP e i dettagli seguenti.",
      ...
      cursorEnvReserved: "È stata sovrascritta una variabile gestita da Cursor o PanDB. Rimuovi CURSOR_CONFIG_DIR, CURSOR_DATA_DIR e PanDB_MCP_* dalla configurazione.",
      cursorNotAuthenticated: "Cursor CLI non è autenticato. Esegui `agent login` nel terminale e riprova.",
      cursorMcpStartupFailed: "Cursor non ha potuto avviare il server PanDB MCP con ambito limitato. Controlla Impostazioni > MCP e i dettagli seguenti.",
      ...
      grokCliEnvReserved: "È stata sovrascritta una variabile MCP gestita da PanDB. Rimuovi le variabili PanDB_MCP_* dalla configurazione del provider.",
      grokCliNotAuthenticated: "Grok CLI non è autenticato. Esegui `grok login` in un terminale e riprova.",
      grokCliMcpStartupFailed: "Grok ha caricato la configurazione MCP ma non ha potuto avviare PanDB MCP Server. Controlla Impostazioni > MCP e i dettagli seguenti.",
      grokCliCommandLineTooLong: "Windows ha rifiutato il comando Grok CLI perché troppo lungo. Aggiorna PanDB e riprova usando il file di prompt generato.",
      ...
      codeBuddyEnvReserved: "È stata sovrascritta una variabile MCP gestita da PanDB. Rimuovi le variabili PanDB_MCP_* dalla configurazione del provider.",
      ...
      codeBuddyMcpConfigInvalid: "CodeBuddy Code non ha potuto leggere la configurazione temporanea di PanDB MCP. Controlla i dettagli seguenti.",
      codeBuddyMcpStartupFailed: "CodeBuddy Code ha caricato la configurazione MCP ma non ha potuto avviare PanDB MCP Server. Controlla Impostazioni > MCP e i dettagli seguenti.",
      ...
      qoderEnvReserved: "È stata sovrascritta una variabile di ambiente MCP gestita da PanDB. Rimuovi le variabili PanDB_MCP_* dalla configurazione del provider.",
      ...
      qoderMcpConfigInvalid: "Qoder CLI non ha potuto leggere la configurazione MCP temporanea di PanDB. Controlla la versione di Qoder CLI e i dettagli seguenti.",
      qoderMcpStartupFailed: "Qoder CLI ha caricato la configurazione MCP ma non ha potuto avviare PanDB MCP Server. Controlla Impostazioni > MCP e i dettagli seguenti.",
  ...
  settings: {
    ...
    syncWebDavWebDescription: "In modalità Web, il server PanDB accede a WebDAV senza le limitazioni CORS del browser. Le password salvate restano nell'istanza PanDB corrente.",
    ...
    syncRememberWebDavPasswordDescription: "La password viene crittografata e memorizzata solo nell'istanza PanDB corrente. Non viene sincronizzata su WebDAV e non sostituisce la password di sincronizzazione.",
    ...
    syncSecretsPassphraseDescription: "Questa password viene utilizzata solo per crittografare e ripristinare i dati sensibili. È crittografata nell'istanza PanDB corrente; inseriscila di nuovo nelle altre istanze.",
    syncTest: "Verifica",
    syncUpload: "Carica",
    ...
    appCloseUnsavedTabsModeDescription: "Scegli cosa succede quando esci da PanDB con schede SQL che contengono modifiche non salvate.",
    appCloseUnsavedTabsModePrompt: "Chiedi se salvare",
    appCloseUnsavedTabsModeKeepDrafts: "Esci e conserva le bozze",
    appCloseUnsavedTabsModeHint: 'Le bozze vengono conservate come schede non salvate e ripristinate al prossimo avvio di PanDB. Richiede che "Ripristina schede all\'avvio" non sia impostato su "Non mantenere schede".',
    appCloseDraftPersistFailed: "PanDB non ha potuto salvare le bozze delle schede aperte, quindi l'uscita è stata annullata. Controlla lo spazio su disco e i permessi dei file, quindi riprova. Dettagli: {message}",
  ...
  driverStore: {
    ...
    offlineExportDescription: "Seleziona i driver Agent gestiti da PanDB da includere. Il pacchetto è compatibile solo con la piattaforma corrente.",
    ...
    offlineExportNoDrivers: "Non sono installati driver Agent gestiti da PanDB idonei all'esportazione.",
    ...
    offlineExportSecurityHint: "Sono inclusi solo gli artefatti gestiti da PanDB e i JRE necessari. Percorsi locali, impostazioni e driver esterni sono esclusi.",
    ...
    offlineExportUnavailable_unmanagedInstall: "L'artefatto non è registrato come installazione gestita da PanDB.",
    ...
    offlineExportUnavailable_missingManagedJre: "Il JRE gestito da PanDB richiesto non è installato.",
    offlineExportUnavailable_invalidManagedJre: "Il JRE gestito da PanDB richiesto non è valido o sicuro.",
    refresh: "Aggiorna",
    ...
    localInstallHint:
      "Per ambienti completamente isolati: su un altro computer con accesso a internet, scarica il pacchetto ufficiale dbx-jdbc-plugin-*.zip dalla pagina Releases di PanDB su GitHub, trasferiscilo su questa macchina e selezionalo: non è richiesto alcun accesso alla rete su questa macchina.",
  ...
  nacos: {
    ...
    namespaceIdPlaceholder: "Lascia vuoto per far generare a PanDB un UUID",
    ...
    nacosDetectAccessibleNamespacesHint: "PanDB verifica la lettura di configurazioni e servizi prima di proporre i namespace per {name}.",
    ...
    nacosV3ConsoleManagedNamespacesHint: "Questa connessione usa l'API Console di Nacos 3 (normalmente porta 8080). Inserisci un nome o ID namespace; PanDB converte il nome nell'ID effettivo quando puo leggere la directory.",
