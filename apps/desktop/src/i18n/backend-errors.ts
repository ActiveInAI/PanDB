...
const patterns: [RegExp, string][] = [
  ...
  [/^Agent requires Java 21, but PanDB started it with an older Java runtime\. Use PanDB managed JRE 21 or select a Java 21 executable in Driver Manager\./, "connection.agentJavaTooOld"],
