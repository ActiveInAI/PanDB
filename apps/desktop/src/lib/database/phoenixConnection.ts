...
export const PHOENIX_JDBC_PLUGIN_NOT_INSTALLED_ERROR = "PanDB JDBC plugin is not installed. Install Apache Phoenix JDBC from the Driver Manager, then retry.";
