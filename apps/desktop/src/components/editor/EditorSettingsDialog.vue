        ...
        <div class="min-w-0 flex-1 overflow-hidden px-1 flex flex-col">
          ...
          <div v-else ref="settingsContentScrollRef" class="min-h-0 flex-1 overflow-y-auto overflow-x-hidden px-1 pr-2">
            ...
            <section v-else-if="activeSettingsTab === 'about'" data-settings-search-id="about" :class="['flex flex-col gap-5 py-2', settingsSearchTargetClass('about')]">
              ...
              <ChangelogPanel v-if="false" />

              <div v-if="false" class="rounded-lg border p-4">
              ...
              <div class="rounded-lg border p-5">
                <div class="flex items-center gap-4">
                  <img src="/logo.png" alt="PanDB" class="h-14 w-14 shrink-0 rounded-xl shadow-sm" />
                  <div class="min-w-0">
                    <div class="text-lg font-semibold tracking-tight">PanDB</div>
                    <div class="mt-1 text-sm text-muted-foreground">PanDB 官方开源项目</div>
                  </div>
                </div>
                <button type="button" class="mt-4 flex w-full items-center gap-2 rounded-md border px-3 py-2 text-left text-sm transition-colors hover:bg-muted/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" @click="openExternalUrl('https://github.com/ActiveInAI')">
                  <img src="https://cdn.simpleicons.org/github/181717" alt="GitHub" class="h-7 w-7 rounded-md bg-white p-1" />
                  <span class="select-text text-primary">github.com/ActiveInAI</span>
